...
Wget2Clipboard.model.Command.Wget = (function (tabUrl, targetUrl, cookies) {
  Wget2Clipboard.model.Command.call(
    this,
    Wget2Clipboard.model.Command.Wget.exec(),
    Wget2Clipboard.model.Command.Wget.parameters(
      tabUrl,
      targetUrl,
      cookies
    )
 ...
 */
Wget2Clipboard.model.Command.Wget.exec = (function() {
 ...
 */
Wget2Clipboard.model.Command.Wget.parameters = (function(tabUrl, targetUrl, cookies) {
